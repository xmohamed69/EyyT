# specs/EyeTyper-Calibrator-mac.spec
# EyeTyper Calibrator — macOS build
# Output: dist/EyeTyperCalibrator.app
...
app = BUNDLE(
    coll,
    name="EyeTyperCalibrator.app",
    icon="calibrator_icon.ico",
    bundle_identifier="com.eyetyper.calibrator",
    info_plist={
        "NSCameraUsageDescription":
            "EyeTyper Calibrator uses your camera to track your eye gaze.",
        "CFBundleShortVersionString": "1.0.0",
        "CFBundleName": "EyeTyper Calibrator",
        "LSUIElement": False,
    },
)
